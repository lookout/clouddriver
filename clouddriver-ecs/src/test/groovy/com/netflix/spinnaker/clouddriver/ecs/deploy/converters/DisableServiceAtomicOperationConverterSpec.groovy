...
class DisableServiceAtomicOperationConverterSpec extends Specification {
  ...
  @Shared
  DisableServiceAtomicOperationConverter converter

  def setupSpec() {
    this.converter = new DisableServiceAtomicOperationConverter(objectMapper: mapper)
  ...
  def 'should convert'() {
    setup:
    def input = [serverGroupName: "test", regions: ["us-west-1"], credentials: "test"]
